          ...
          <Route path="/" element={
            <PageTransition>
              ...
              <main className="container mx-auto px-4 py-12 md:py-20">
                ...
                <section id="ai-recommender" className="mt-8 md:mt-16 mb-16">
                  <div className="text-center mb-8">
                    <span className="inline-block text-stone-500 uppercase tracking-[0.3em] text-xs font-bold border-b border-stone-300 pb-2 mb-4">
                      Powered by Intelligence
                    </span>
                    <h2 className="text-4xl md:text-5xl font-serif text-stone-900 leading-tight">
                      Not sure which stone? <br /><span className="italic text-stone-400">Let us find it for you.</span>
                    </h2>
                  </div>
                  <AIStoneRecommender />
                </section>
